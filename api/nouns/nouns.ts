...
export const nouns: Noun[] = [
  ...
  { singular: 'Torte', article: 'die', plural: 'Torten', tags: ['Lebensmittel'] },
  ...
  { singular: 'Vorname', article: 'der', plural: 'Vornamen', tags: ['Familie'] },
  {
  ...
  { singular: 'Nachname', article: 'der', plural: 'Nachnamen', tags: ['Familie'] },
  { singular: 'Familie', article: 'die', plural: 'Familien', tags: ['Familie'] },
  { singular: 'Apfel', article: 'der', plural: 'Äpfel', tags: ['Lebensmittel'] },
  { singular: 'Banane', article: 'die', plural: 'Bananen', tags: ['Lebensmittel'] },
  { singular: 'Brot', article: 'das', plural: 'Brote', tags: ['Lebensmittel'] },
  { singular: 'Kaffee', article: 'der', plural: 'Kaffees', tags: ['Lebensmittel'] },
  { singular: 'Milch', article: 'die', plural: 'Milch', tags: ['Lebensmittel'] },
  { singular: 'Wasser', article: 'das', plural: 'Wasser', tags: ['Lebensmittel'] },
  {
  ...
  { singular: 'Wohnort', article: 'der', plural: 'Wohnorte', tags: ['Adresse'] },
  ...
  { singular: 'Südosten', article: 'der', plural: 'Südosten', tags: ['Geografie'] },
  {
    singular: 'Nordwesten',
    article: 'der',
    plural: 'Nordwesten',
  ...
  { singular: 'Jahr', article: 'das', plural: 'Jahre', tags: ['Kalender', 'Zeit'] },
  { singular: 'Adresse', article: 'die', plural: 'Adressen', tags: ['Adresse'] },
  {
  ...
  { singular: 'Nachbar', article: 'der', plural: 'Nachbarn', tags: ['Adresse'] },
  {
    singular: 'Nachbarin',
    article: 'die',
    plural: 'Nachbarinnen',
  ...
  { singular: 'Verkäufer', article: 'der', plural: 'Verkäufer', tags: ['Beruf'] },
  {
  ...
  { singular: 'Lehrerin', article: 'die', plural: 'Lehrerinnen', tags: ['Beruf'] },
  ...
  { singular: 'Architekt', article: 'der', plural: 'Architekten', tags: ['Beruf'] },
  {
  ...
  { singular: 'Ingenieur', article: 'der', plural: 'Ingenieure', tags: ['Beruf'] },
  {
  ...
  { singular: 'Dienstag', article: 'der', plural: 'Dienstage', tags: ['Kalender'] },
  { singular: 'Mittwoch', article: 'der', plural: 'Mittwoche', tags: ['Kalender'] },
  {
    singular: 'Donnerstag',
    article: 'der',
    plural: 'Donnerstage',
  ...
  { singular: 'Freitag', article: 'der', plural: 'Freitage', tags: ['Kalender'] },
  { singular: 'Samstag', article: 'der', plural: 'Samstage', tags: ['Kalender'] },
  { singular: 'Sonntag', article: 'der', plural: 'Sonntage', tags: ['Kalender'] },
  { singular: 'Januar', article: 'der', plural: 'Januare', tags: ['Kalender'] },
  { singular: 'Februar', article: 'der', plural: 'Februare', tags: ['Kalender'] },
  ...
  { singular: 'Oktober', article: 'der', plural: 'Oktobers', tags: ['Kalender'] },
  { singular: 'November', article: 'der', plural: 'November', tags: ['Kalender'] },
  { singular: 'Dezember', article: 'der', plural: 'Dezember', tags: ['Kalender'] },
  { singular: 'Frühling', article: 'der', plural: 'Frühlinge', tags: ['Kalender'] },
  ...
  { singular: 'Kalender', article: 'der', plural: 'Kalender', tags: ['Kalender'] },
  { singular: 'Handtuch', article: 'das', plural: 'Handtücher', tags: ['Haus'] },
  ...
  { singular: 'Autobahn', article: 'die', plural: 'Autobahnen', tags: ['Stadt'] },
  {
    singular: 'Nudel',
    article: 'die',
    plural: 'Nudeln',
